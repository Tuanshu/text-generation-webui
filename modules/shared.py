...
parser.add_argument('--model-menu', action='store_true',
...
parser.add_argument('--cpu-memory', type=str,
...
parser.add_argument('--disk-cache-dir', type=str, default="cache",
...
parser.add_argument('--trust-remote-code', action='store_true',
                    help="Set trust_remote_code=True while loading a model. Necessary for ChatGLM.")

# llama.cpp
parser.add_argument('--threads', type=int, default=0, help='Number of threads to use in llama.cpp.')
# ts note: seem this value should be 1024, but also 8 in langchain
...
parser.add_argument('--pre_layer', type=int, default=0,
                    help='The number of layers to allocate to the GPU. Setting this parameter enables CPU offloading for 4-bit models.')
...
parser.add_argument('--percent', type=int, nargs="+", default=[
                    0, 100, 100, 0, 100, 0], help='FlexGen: allocation percentages. Must be 6 numbers separated by spaces (default: 0, 100, 100, 0, 100, 0).')
...
# RWKV
parser.add_argument('--rwkv-strategy', type=str, default=None,
...
parser.add_argument("--gradio-auth-path", type=str,
                    help='Set the gradio authentication file path. The file should contain one or more user:password pairs in this format: "u1:p1,u2:p2,u3:p3"', default=None)
